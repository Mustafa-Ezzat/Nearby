...
class ExploreResponsableTestCase: XCTestCase {
    var sut: ExploreResponsable!
     override func setUp() {
         super.setUp()
         // should init after super.setup()
         sut = ExploreResponsable()
     }
    ...
    func test_ExploreResponsable_ResponseWithEmptyJSON() {
        let emptyJSON = Data("{\"response\": {\"groups\": []}}".utf8)
